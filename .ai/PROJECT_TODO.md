...
| 12 | Directory | CRITICAL: Fix clientType initialization - Type switching when adding Client role | CODE WRITER | DONE | - | - | FIXED per PROJECT_LOG.md [2026-01-04 22:50]. При добавлении Client к записи с Type=Company, Type переключается на Person. |
...
| 16 | Deploy | CRITICAL: Fix Vercel build - Supabase init error | CODE WRITER | DONE | - | - | FIXED: Added placeholder URLs for build-time. Build passes locally. |
