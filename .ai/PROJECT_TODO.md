...
| S12 | Orders | HOTEL Add/Edit modal redesign with 6 selectable variants | CODE WRITER → QA | DONE | cursor/order-services-block-rendering-6a80 | ✅ 6 distinct layouts implemented in Add + Edit, API mapping extended for hotel fields |
