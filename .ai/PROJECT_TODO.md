...
|----|------|------|----------|---------|--------|-------|-------------|
| OD1 | Orders | Увеличить размер шрифтов на странице заказа | CW→QA | CW | READY_FOR_QA | - | [09.01 20:45] Fonts increased |
| OD2 | Orders | Карта на всю ширину внизу секции клиента | CW→QA | CW | READY_FOR_QA | - | [09.01 20:45] Map moved fullwidth |
| OD3 | Orders | Дни/ночи в скобках после дат | CW→QA | CW | READY_FOR_QA | - | [09.01 20:45] Days/nights added |
