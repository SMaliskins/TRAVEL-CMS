...
export async function POST(
  ...
  try {
    ...
    const baseFields: Record<string, unknown> = {
      ...
      hotel_early_check_in_time: (originalService as { hotel_early_check_in_time?: string | null }).hotel_early_check_in_time,
      hotel_late_check_in_time: (originalService as { hotel_late_check_in_time?: string | null }).hotel_late_check_in_time,
      hotel_room_upgrade: (originalService as { hotel_room_upgrade?: boolean | null }).hotel_room_upgrade,
      hotel_late_check_out: (originalService as { hotel_late_check_out?: boolean | null }).hotel_late_check_out,
      hotel_late_check_out_time: (originalService as { hotel_late_check_out_time?: string | null }).hotel_late_check_out_time,
