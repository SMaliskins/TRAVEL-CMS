                                ...
                                {service.invoice_id ? (
                                  <div className="flex items-center gap-2">
                                    ...
                                    <button
                                      ...
                                      onMouseEnter={(e) => {
                                        // TODO: Show preview tooltip
                                        console.log('Show invoice preview:', service.invoice_id);
                                      }}
                                      className="group relative text-blue-600 hover:text-blue-800 transition-colors"
                                      title="View invoice"
                                    >
                                      <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
