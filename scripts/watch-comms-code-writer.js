#!/usr/bin/env node
/**
 * Code Writer COMMS Watcher
 * 
 * Monitors .ai/COMMS_TODO.md for tasks with Status=READY and Owner=Code Writer
...
function checkTasks() {
  ...
  if (readyTasks.length > 0) {
    ...
    console.log(`\n🔔 [${timestamp}] Found ${readyTasks.length} READY task(s) for Code Writer:`);
...
function main() {
  console.log('🚀 Code Writer COMMS watcher started');
