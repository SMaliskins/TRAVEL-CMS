...
### Передача роли (критично)
- Каждый агент в конце своей работы **ОБЯЗАН передать роль следующему агенту**
- Формат: `**[Следующий: AGENT_NAME]** — краткое описание что делать`
- Следующий агент читает свою роль в PROJECT_RULES.md и подхватывает задачу
